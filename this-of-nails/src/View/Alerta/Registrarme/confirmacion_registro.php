...
*/
    ...
    if($_GET['nuevoregistro']!="confirmacionregistro"){
        header('location:../AccesoDenegado=restringido');
    }
...
<html lang="ES-SV">
   <head>
      ...
      <title>Secret - Registro Exitoso Bienvenido(a)</title>
      <!-- Favicon -->
   ...
   <body onload="MensajeConfirmacion();">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 bg-white pt-5">
                        <div class="sign-in-from">
                            <h1 class="mt-3 mb-0">¡Bienvenido a la familia Secret! &#128521;</h1>
                            <img style="display: block; margin: auto;" src="../vista/images/logo.png" width="190">
                            <p><strong><h4>Estimado(a) <?php echo $_SESSION['nombre_usuarioregistro']; ?></h4></strong> Te damos una cordial bienvenida, nos alegra mucho tenerte aqu&iacute;,
                            esperamos suplir todas tus necesidades y comunicarte con los que m&aacute;s quieres.</p>
                            <p>Por favor haz clic en el bot&oacute;n para proceder a iniciar sesi&oacute;n y completar tu perfil.</p>
                            <div class="d-inline-block w-100">
                                <a href="../IniciarSesion/inicio"><button type="submit" class="btn btn-primary mt-3">Iniciar Sesi&oacute;n</button></a>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <!-- Alert -->
      <script src="../vista/Alertas/Registrarme/confirmacion_registro.js"></script>
   </body>
</html>